...
const componentName = 'CoastFormComponent';

describe(`${moduleName}.${componentName}`, () => {
  let testTarget: CoastFormComponent;
  ...
  beforeEach(() => {
    ...
    testTarget = new CoastFormComponent(datePipeMock, routerMock, authServiceMock, messageMock, storeMock);
  });
  ...
  describe('#ngOnInit', () => {
    it('should call message.open with parameter class error', () => {
      ...
      const testObj = {
        ...
        data: {
          content: 'Error, the purchase was not saved', class: 'error', time: 800
        }
      };
    ...
    it('should call message.open with parameter class success and router.navigate with ["/main"]', () => {
      ...
      const testObj = {
        panelClass: 'my-custom-container',
        data: {
          content: 'The purchase was saved successfully', class: 'success', time: 800
        }
      };
